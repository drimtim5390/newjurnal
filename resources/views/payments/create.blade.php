            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input autofocus id="madedate" class="form-control alert alert-light border-secondary" type="date" name="madedate" required>
                    </div>
                    <div class="col-md-2">
                        <label>Тўлов суммаси</label>
                        <input class="form-control alert alert-light border-secondary" type="number" name="summ" required placeholder="{{number_format($export->fema,'2','.',' ')}}">
                    </div>
	        	</div>
            </div>
