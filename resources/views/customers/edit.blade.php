                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="phonenumberextra" name="phonenumber1" value="{{$export->customer->phonenumber1}}">
                            </div>
                            <div class="col-md-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" id="pgivenby" name="pgivenby">
                                    ...
                                    <option @if(old('pgivenby',$export->customer->pgivenby) == 'Хоразм вилояти Боғот туман ИИБ') selected @endif value="Хоразм вилояти Боғот туман ИИБ">
                                        Хоразм вилояти Боғот туман ИИБ
                                    </option>
                                    <option @if(old('pgivenby',$export->customer->pgivenby) == 'Хоразм вилояти Шовот туман ИИБ') selected @endif value="Хоразм вилояти Шовот туман ИИБ">
